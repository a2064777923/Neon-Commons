  ...
  io.on("connection", (socket) => {
    socket.on(SOCKET_EVENTS.room.subscribe, ({ roomNo }) => {
      try {
        ...
        socket.emit(SOCKET_EVENTS.room.error, { error: error.message });
      }
    });
    ...
    socket.on(SOCKET_EVENTS.party.subscribe, ({ roomNo }) => {
      try {
        ...
        socket.emit(SOCKET_EVENTS.party.error, { error: error.message });
      }
    });
    ...
    socket.on(SOCKET_EVENTS.board.subscribe, ({ roomNo }) => {
      try {
        ...
        socket.emit(SOCKET_EVENTS.board.error, { error: error.message });
      }
    });
