...
function findSuggestedPlay(hand, lastPlay = null) {
  return listSuggestedPlays(hand, lastPlay)[0] || null;
}

function listSuggestedPlays(hand, lastPlay = null) {
  const candidates = buildPlayCandidates(hand);
...
function buildPlayCandidates(hand) {
